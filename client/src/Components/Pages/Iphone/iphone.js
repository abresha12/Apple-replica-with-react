...
import iphoneDatabase from "../iphonedata/database"; // Adjust the path accordingly

function Iphone() {
  const [products, setProducts] = useState([]);

  useEffect(() => {
    // Instead of fetching from the remote server, use the local database
    setProducts(iphoneDatabase);
  }, []);
